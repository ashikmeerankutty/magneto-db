...
public class MagnetoRouter implements Node{
  ...
  public static void main(String[] args) {
      ...
      MagnetoRouter node1 = new MagnetoRouter("IDC1","127.0.0.1",8080);
      MagnetoRouter node2 = new MagnetoRouter("IDC1","127.0.0.1",8081);
      MagnetoRouter node3 = new MagnetoRouter("IDC1","127.0.0.1",8082);
      MagnetoRouter node4 = new MagnetoRouter("IDC1","127.0.0.1",8084);
